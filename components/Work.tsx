      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <h2
          className="
            ...
            mx-auto
            max-lg:w-[300px]
            max-md:w-[250px] max-md:text-[40px]
            max-sm:w-full max-sm:text-[28px] max-sm:text-center hover:underline hover:decoration-brand-blue
          "
        >
          How it Works
        </h2>
              ...
              <div key={i} className="flex flex-col items-center w-full max-w-[200px] text-center">
                <div className="w-[100px] h-[100px] relative mb-5 overflow-hidden">
                  ...
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="relative z-10 mx-auto mt-[28px]"
                  />
                </div>
