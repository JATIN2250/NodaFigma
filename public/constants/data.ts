...
export const howItWorksSteps = [
    {
      ...
      description: "Enter meeting agendas and key outcomes before the meeting begins",
      icon: "/images/h1.svg",
    },
    {
      title: "Invite Attendees",
      description: "Sync Noda with email and add it to meeting invites",
      icon: "/images/h2.svg",
    },
    {
      title: "Run Meeting",
      description: "Conduct structured meetings within Noda to help stay organized",
      icon: "/images/h3.svg",
    },
    {
      title: "Always Accessible",
      description: "Easily find important meeting notes & decisions whenever you need",
      icon: "/images/h4.svg",
    },
];