      ...
      <div className="bg-white flex items-center justify-center md:h-screen p-4">
        <div className="[box-shadow:rgba(149,157,165,0.3)_0px_4px_18px] rounded-md max-md:max-w-lg lg:w-[1000px] lg:h-[700px] flex overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 h-full w-full">
            ...
            <form className="max-md:order-1 md:max-w-md w-full mx-auto p-10 flex flex-col justify-center ">
              ...
              <div className="mb-4 relative">
                <input
                  ...
                  id="fullname-input"
                  required
                  className="md:w-full lg:h-[40px] lg:w-[400px] text-sm border border-brand-blue rounded-md px-4 pt-[18px] pb-2 outline-none focus:border-brand-blue rounded-[10px] border-[1px] peer "
                  placeholder=""
                />
                <label
              ...
              <div className="mb-4 relative mt-5">
                <input
                  ...
                  id="email-input"
                  required
                  className="md:w-full lg:h-[40px] lg:w-[400px] text-sm border border-brand-blue rounded-md px-4 pt-[18px] pb-2 outline-none focus:border-brand-blue rounded-[10px] border-[1px]"
                  placeholder=""
                />
                <label
                  htmlFor="email-input"
              ...
              <div>
                <button type="submit" className="md:w-full lg:w-[400px] lg:h-[45px] shadow-lg py-3 px-4 text-[16px] font-montserrat font-bold leading-[100%] rounded-[10px] cursor-pointer text-background bg-brand-blue hover:bg-brand-blue/90 focus:outline-none lg:mt-10">
                  Sign In
                </button>
              </div>
              ...
              <div className="h-[50px] md:w-full ml-10 flex items-center justify-center ">
                <div className="h-[25px] w-[250px] text-gray-400 text-[14px] ">
                  Already have an account? <Link href="/SignIn" className="text-brand-blue font-semibold underline font-montserrat ">Login</Link>
                </div>
              </div>
            </form>
